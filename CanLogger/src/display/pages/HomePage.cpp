...
void HomePage::loop()
{
    ...
    if(hasEncoderPosChanged())
    {
        ...
        if(getEncoderPos() == 0)
        {
            ...
            this->pfeilNichtSpeichern->draw(this->display.makeColor(this->COLOR_ARROW_SELECTED[0],this->COLOR_ARROW_SELECTED[1],this->COLOR_ARROW_SELECTED[2]));
        ...
        if(getEncoderPos() == 1)
        {
            ...
            this->pfeilSpeichern->draw(this->display.makeColor(this->COLOR_ARROW_SELECTED[0],this->COLOR_ARROW_SELECTED[1],this->COLOR_ARROW_SELECTED[2]));
        }
        if(getEncoderPos() > 1)
        {
            setEncoderPos(1);
...
void HomePage::startView()
{
    ...
    this->buttonNichtSpeichern = new Button{this->display, xmitte-this->BUTTON_WIDTH/2,ymitte-this->BUTTON_MID_DIST-this->BUTTON_HIGH+this->BUTTON_Y_AXE_OFFSET,this->BUTTON_WIDTH,this->BUTTON_HIGH,this->display.makeColor(this->COLOR_BUTTON_DEFAULT[0],this->COLOR_BUTTON_DEFAULT[1],this->COLOR_BUTTON_DEFAULT[2]),this->BUTTON_TEXT_DST_X,this->BUTTON_TEXT_DST_Y,"Logging - ohne Speichern",this->COLOR_BUTTON_TEXT,!this->statusSD};
    this->buttonSpeichern = new Button{this->display, xmitte-this->BUTTON_WIDTH/2,ymitte+this->BUTTON_MID_DIST+this->BUTTON_Y_AXE_OFFSET,this->BUTTON_WIDTH,this->BUTTON_HIGH,this->display.makeColor(this->COLOR_BUTTON_DEFAULT[0],this->COLOR_BUTTON_DEFAULT[1],this->COLOR_BUTTON_DEFAULT[2]),this->BUTTON_TEXT_DST_X,this->BUTTON_TEXT_DST_Y,"Logging - mit Speichern",this->COLOR_BUTTON_TEXT,this->statusSD};
    this->pfeilNichtSpeichern = new Arrow{this->display,this->buttonNichtSpeichern,this->display.makeColor(this->COLOR_ARROW_SELECTED[0],this->COLOR_ARROW_SELECTED[1],this->COLOR_ARROW_SELECTED[2]),this->COLOR_ARROW_UNSELECTED,!this->statusSD};
    this->pfeilSpeichern = new Arrow{this->display,this->buttonSpeichern,this->display.makeColor(this->COLOR_ARROW_SELECTED[0],this->COLOR_ARROW_SELECTED[1],this->COLOR_ARROW_SELECTED[2]),this->COLOR_ARROW_UNSELECTED,this->statusSD};
